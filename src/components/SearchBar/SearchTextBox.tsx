...
const SearchTextBox: RC.FC<{
    ...
    return (
        <div className='w-[330px] h-11 sm:w-[390px] sm:h-10 md:w-[320px] md:h-10 lg:w-[360px] lg:h-8 bg-gray-600 border border-black rounded-xl p-4 flex items-center gap-2 outline-none cursor-pointer'>
